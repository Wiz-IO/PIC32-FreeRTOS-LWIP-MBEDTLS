...
#define MBEDTLS_PLATFORM_STD_PRINTF   /*[WizIO] DIASBLED */
#endif
 ...
 */
#ifndef PIC32_BOOTLOADER_USE_MBEDTLS
#include "FreeRTOS.h"
#endif
 ...
 */
#if defined(PIC32_DEBUG_LEVEL_NONE)
#define mbedtls_printf
#else /* PIC32_DEBUG_LEVEL_NONE */
...
#else
#ifdef MBEDTLS_PIC32
#define LOG_I(mbedtls, x, ...)    LOG("[SSL] "x, ##__VA_ARGS__)
#define mbedtls_printf(x, ...)    LOG_I(0, x, ##__VA_ARGS__)
#else
#define mbedtls_printf     TRACE
#endif
#endif /* MBEDTLS_PLATFORM_PRINTF_MACRO */
#endif /* MBEDTLS_PLATFORM_PRINTF_ALT */
#endif /* PIC32_DEBUG_LEVEL_NONE */
