                             ...
                             mbedtls_x509_crl_entry *entry )
{
    ...
    while( *p < end )
    {
        ...
        if( *p < end )
        {
            cur_entry->next = (struct mbedtls_x509_crl_entry *)mbedtls_calloc( 1, sizeof( mbedtls_x509_crl_entry ) );
                        ...
                        const unsigned char *buf, size_t buflen )
{
    ...
    {
        crl->next = (struct mbedtls_x509_crl *)mbedtls_calloc( 1, sizeof( mbedtls_x509_crl ) );
